...
|0.7|`Logstash` 5.4.3 安装|-|2017年7月25日|
|0.8|`Filebeat` 5.4.3 安装|-|2017年7月25日|
|-||||
|1|ES索引数据结构搭建|-|-|
...
|1.9|设置`index template`|-|2017年7月25日|
|-||||
|2|数据同步逻辑|-|-|
...
|6.0|搜索整体逻辑结构设计|-||
|6.1|搜索日志数据结构实现|-||
|6.2|`filebeat`日志采集|-|2017年7月19日|
|6.3|`logstash`日志采集|`input`|2017年7月20日|
|6.4|`logstash`日志过滤|`filter`|2017年7月21日|
|6.5|`logstash`日志写入`es`|`output`|2017年7月24日|
|6.6|`index template`实现|-|2017年7月25日|
